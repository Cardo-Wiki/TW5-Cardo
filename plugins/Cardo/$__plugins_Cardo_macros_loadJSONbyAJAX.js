/*\
title: $:/plugins/Cardo/macros/loadJSONbyAJAX.js
type: application/javascript
module-type: macro

Macro to call a URL through AJAX, and parse a JSON result into a Tiddler

<<loadJSONbyAJAX url:"properurl">>
...
//alert("2: " + AJAXresponse);
  ...
  function getMessageList(url, onlyNew, onlyFlagged, maxEmails, groupBy, title) {
      ...
      if (String(mailList).substring(0,3) == "Err") {
        ...
        //FROM TW2.6 store.suspendNotifications();
...
//alert("Adding " + message.subject); 
            ...
            wikifyThis += decodeURIComponent(message.subject);
            if (readStatus == false) { wikifyThis += "''"; }
			wikifyThis += "</span><br>";
            // From "Name (address)"
