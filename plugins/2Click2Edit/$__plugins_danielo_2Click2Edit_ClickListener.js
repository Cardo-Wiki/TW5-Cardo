/*\
title: $:/plugins/danielo/2Click2Edit/ClickListener.js
type: application/javascript
module-type: widget

This widgets adds an double click event listener to its parent. See $:/plugins/danielo/2Click2Edit/License
